...
export default function Sidebar({drawerShow, setDrawerShow, drawerRef, user, userRole, handleLogout}) {
  ...
  return (
    <aside className={`py-8 px-6 lg:hidden fixed top-0 bottom-0 w-4/5 max-w-[300px] bg-secondary transition-[left] duration-300 z-50 ${drawerShow ? 'left-0' : '-left-[350px]'}`} ref={drawerRef}>
      {
